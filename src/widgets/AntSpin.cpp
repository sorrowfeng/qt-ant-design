...
Ant::Size AntSpin::size() const { return m_size; }

void AntSpin::setSize(Ant::Size size)
{
    if (m_size == size)
    {
        return;
...
const AntSpin::SpinLayoutCache& AntSpin::spinLayout() const
{
    ...
    cache.percentFontSize = m_size == Ant::Size::Large ? 10 : 8;
